...
LOAD DATA LOCAL INFILE '/Users/rnash/github/CUNY-DATA-607/flights/airlines.csv' 
INTO TABLE airlines 
...
LOAD DATA LOCAL INFILE '/Users/rnash/github/CUNY-DATA-607/flights/airports.csv' 
INTO TABLE airports
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE '/Users/rnash/github/CUNY-DATA-607/flights/flights.csv' 
INTO TABLE flights
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE '/Users/rnash/github/CUNY-DATA-607/flights/planes.csv' 
INTO TABLE planes
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE '/Users/rnash/github/CUNY-DATA-607/flights/weather.csv' 
INTO TABLE weather
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
